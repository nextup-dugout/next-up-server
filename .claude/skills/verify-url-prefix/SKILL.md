...
**현재 알려진 위반:**
- `BracketManagementController.kt` — `/backoffice/v1/...` 사용 중 (→ `/api/backoffice/...`로 변경 필요)
...
**현재 알려진 위반:**
- `PitchEventRecordController.kt` — `/scorer/v1/...` 사용 중
- `LineupScorerController.kt` — `/api/v1/scorer/...` 사용 중
...
|---|------|------|--------------|--------------|--------|
| 1 | backoffice | `BracketManagementController.kt` | `/backoffice/v1/` | `/api/backoffice/` | 🟠 REJECT |
| 2 | scorer | `PitchEventRecordController.kt` | `/scorer/v1/` | `/api/scorer/` | 🟠 REJECT |
```
