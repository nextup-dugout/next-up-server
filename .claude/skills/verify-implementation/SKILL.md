...
| # | 스킬 | 설명 |
|---|------|------|
| 1 | `verify-entity-leak` | Controller 반환 타입에 Entity 직접 노출 방지 |
| 2 | `verify-dependency` | 멀티모듈 의존성 방향 규칙 검증 |
...
| # | 스킬 | 파일 | 문제 | 수정 방법 |
|---|------|------|------|-----------|
| 1 | verify-<name1> | `path/to/File.kt:42` | 문제 설명 | 수정 코드 예시 |
| 2 | verify-<name2> | `path/to/File.kt:15` | 문제 설명 | 수정 코드 예시 |
```
...
- [1/X] verify-<name1>: `path/to/File.kt` 수정 완료
- [2/X] verify-<name2>: `path/to/File.kt` 수정 완료
...
| # | 스킬 | 파일 | 문제 |
|---|------|------|------|
| 1 | verify-<name> | `path/to/File.kt:42` | 자동 수정 불가 — 수동 확인 필요 |
