...
interface BattingRecordRepository : JpaRepository<BattingRecord, Long> {
    ...
    fun findByGamePlayerId(@Param("gamePlayerId") gamePlayerId: Long): BattingRecord?
    ...
    """)
    fun findAllByGameId(@Param("gameId") gameId: Long): List<BattingRecord>
    ...
    """)
    fun findAllByPlayerId(@Param("playerId") playerId: Long): List<BattingRecord>
    ...
    @Query("""
        ...
        LIMIT :limit
    """)
    fun findTopByHomeRuns(@Param("limit") limit: Int): List<BattingRecord>
